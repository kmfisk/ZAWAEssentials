...
public class AustralianRingneckParrotEntity extends ZawaFlyingEntity implements SpeciesVariantsEntity, OviparousEntity {
    public AustralianRingneckParrotEntity(EntityType<? extends ZawaFlyingEntity> type, World world) {
        super(type, world);
    }
    ...
    public AgeableEntity getBreedOffspring(ServerWorld world, AgeableEntity entity) {
        return ZEEntities.AUSTRALIAN_RINGNECK_PARROT.get().create(world);
    }

    @Override
    public ItemStack getBreedEggItem() {
        return ZEItems.AUSTRALIAN_RINGNECK_PARROT_EGG.get().getDefaultInstance();
    }
