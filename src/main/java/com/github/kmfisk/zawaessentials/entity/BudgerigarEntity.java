...
public class BudgerigarEntity extends ZawaFlyingEntity implements OviparousEntity {
    public BudgerigarEntity(EntityType<? extends ZawaFlyingEntity> type, Level world) {
        super(type, world);
    }
    ...
    public static AttributeSupplier.Builder registerAttributes() {
        ...
        return createMobAttributes().add(Attributes.FLYING_SPEED, 1.2F).add(Attributes.MOVEMENT_SPEED, 0.3F).add(Attributes.MAX_HEALTH, 4.0).add(Attributes.ATTACK_DAMAGE, 1.0);
    }
