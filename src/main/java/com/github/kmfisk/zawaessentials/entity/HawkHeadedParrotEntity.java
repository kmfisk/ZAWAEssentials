...
public class HawkHeadedParrotEntity extends ZawaFlyingEntity implements OviparousEntity {
    public HawkHeadedParrotEntity(EntityType<? extends ZawaFlyingEntity> type, Level world) {
        super(type, world);
    }
    ...
    public ItemStack getBreedEggItem() {
        return ZEItems.HAWK_HEADED_PARROT_EGG.get().getDefaultInstance();
    }
}
