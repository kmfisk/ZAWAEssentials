...
public class EntityKakapo extends EssentialsBaseFlying {
    ...
    public AnimalPack getPack() {
        return AnimalPacksEssentials.KAKAPO;
    }

    /*@NotNull
    @Override
    public Animation getSleepAnimation() {
        return new Animation(ModEntityPoses.KAKAPO, ModEntityPoses.KAKAPO_SLEEP);
    }*/
