...
public class EntityKakariki extends EssentialsBaseFlying {
    public EntityKakariki(World worldIn) {
        super(worldIn);
        setSize(0.5F, 0.5F);
    }
    ...
    public AnimalPack getPack() {
        return AnimalPacksEssentials.KAKARIKI;
    }

    @NotNull
    @Override
    public Animation getSleepAnimation() {
        return new Animation(ModEntityPoses.KAKARIKI, ModEntityPoses.KAKARIKI_SLEEPING);
    }
