...
public class EntityGreenCheekConure extends EssentialsBaseFlying {
    public EntityGreenCheekConure(World worldIn) {
        super(worldIn);
        setSize(0.5F, 0.5F);
    }
    ...
    public AnimalPack getPack() {
        return AnimalPacksEssentials.GREEN_CHEEK_CONURE;
    }
