...
public class EntityKea extends EssentialsBaseFlying {
    public EntityKea(World worldIn) {
        super(worldIn);
        setSize(0.5F, 0.5F);
    }
    ...
    public AnimalPack getPack() {
        return AnimalPacksEssentials.KEA;
    }

    @NotNull
    @Override
    public Animation getSleepAnimation() {
        return new Animation(ModEntityPoses.KEA, ModEntityPoses.KEA_SLEEPING);
    }
